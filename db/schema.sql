...
VALUES ('7165432', 'Product Name 1', 'product-name-1', 'http://127.0.0.1:8080/product/product-name-1', 'Full description of the product', 'Short description of the product', 29.99, 39.99, 19.99, TRUE, 100, 500);
...
VALUES ('6543212', 'Product Name 2', 'product-name-2', 'http://127.0.0.1:8080/product/product-name-2', 'Full description of the product', 'Short description of the product', 32.00, 32.00, 0.00, FALSE, 0, 'outofstock', 120);
...
-- 3 --
INSERT INTO products (sku, name, slug, permalink, description, short_description, price, regular_price, sale_price, on_sale, stock_quantity, weight)
VALUES ('6754321', 'Product Name 3', 'product-name-3', 'http://127.0.0.1:8080/product/product-name-3', 'Full description of the product', 'Short description of the product', 60.00, 65.50, 60.00, TRUE, 51, 210);
...
-- 4 --
INSERT INTO products (sku, name, slug, permalink, description, short_description, price, regular_price, sale_price, on_sale, stock_quantity, weight)
VALUES ('7439876', 'Product Name 4', 'product-name-4', 'http://127.0.0.1:8080/product/product-name-4', 'Full description of the product', 'Short description of the product', 41.00, 41.00, 41.00, FALSE, 20, 150);
...
-- 5 --
INSERT INTO products (sku, name, slug, permalink, description, short_description, price, regular_price, sale_price, on_sale, stock_quantity, weight)
VALUES ('6598764', 'Product Name 5', 'product-name-5', 'http://127.0.0.1:8080/product/product-name-5', 'Full description of the product', 'Short description of the product', 50.10, 74.00, 50.10, TRUE, 20, 150);
...
-- 6 --
INSERT INTO products (sku, name, slug, permalink, description, short_description, price, regular_price, sale_price, on_sale, stock_quantity, weight)
VALUES ('6789001', 'Product Name 6', 'product-name-6', 'http://127.0.0.1:8080/product/product-name-6', 'Full description of the product', 'Short description of the product', 20.50, 20.50, 20.50, FALSE, 34, 120);
