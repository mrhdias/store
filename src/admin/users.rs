...
pub async fn list(
    ...
    let users_manager = Users::new(pool).await;

    let per_page = pagination.per_page.unwrap_or(10);

    let total_pages: i32 = (users_manager.total_count as f32 / per_page as f32).ceil() as i32;
    ...
    match users_manager.get_all(
        ...
        Ok(users) => {
            ...
            data.insert("total_users", &users_manager.total_count);
